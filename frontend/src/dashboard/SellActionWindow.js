...
const SellActionWindow = ({ uid }) => {
  ...
  const handleSellClick = async () => {
    try {
      const holdingsRes = await axios.get("https://treda-krne.onrender.com/getHoldings", { withCredentials: true });
      ...
      const res = await axios.post("https://treda-krne.onrender.com/newOrder", {
        name: uid,
        qty: stockQuantity,
        price: stockPrice,
        mode: "SELL",
