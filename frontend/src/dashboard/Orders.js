...
function Orders() {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                const res = await axios.get("https://treda-krne.onrender.com/getOrders",{withCredentials:true});
    ...
    const deleteOrder=async (orderId)=>{
        try{
            await axios.delete(`https://treda-krne.onrender.com/deleteOrder/${orderId}`,{withCredentials:true});
